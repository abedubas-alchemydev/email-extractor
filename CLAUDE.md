...
<!--
Auto-generated by Claude Code CLI's /init command.
Do NOT edit by hand; re-run /init to refresh.
This section will be populated after the scaffold prompt runs.
-->

_(pending — populated by `/init` during the initial-scaffold run)_
