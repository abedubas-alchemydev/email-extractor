...
class NameLookupEnrichProvider(EmailEnrichmentProvider):
    ...
    def is_configured(self) -> bool:
        ...
        return bool(settings.apollo_api_key or settings.pdl_api_key or settings.hunter_api_key)
...
def _alt_email(hit: DiscoveryResult, discovered: str) -> str | None:
    ...
    personal = [h.value for h in hit.emails if h.type == "personal" and h.value.lower() != discovered_l]
    if personal:
        return personal[0]
