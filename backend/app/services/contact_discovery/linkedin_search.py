...
class LinkedInSearchProvider(ContactDiscoveryProvider):
    ...
    async def _search(self, first: str, last: str, org_name: str) -> list[SerpResult]:
...
def _name_matches(r: SerpResult, first: str, last: str) -> bool:
    ...
    first_lc, last_lc = first.lower(), last.lower()
    haystack = slug_tokens | title_tokens
    return first_lc in haystack and last_lc in haystack
